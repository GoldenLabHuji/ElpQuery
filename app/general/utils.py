...
import pandas as pd
from app.models.word import StringWord, NumericWord
from app.models.attribute import NumericAttribute
from app.models.operator import Operator


def query_numeric_words(df: pd.DataFrame, word_params: NumericWord) -> list:
    """
...
def query_string_words(df: pd.DataFrame, word_params: StringWord) -> list:
    pass
